...
Begin VB.Form frmWhatUseObject 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "What use the object"
   ClientHeight    =   5685
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7470
   Icon            =   "frmWhatUseObject.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin MSComctlLib.ImageList imlIcons 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmWhatUseObject.frx":0442
            Key             =   "IcoTable"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmWhatUseObject.frx":059C
            Key             =   "IcoView"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmWhatUseObject.frx":06F6
            Key             =   "IcoProc"
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Label Label1 
      Caption         =   "Parents of selected object:"
      Height          =   255
      Left            =   120
      TabIndex        =   2
      Top             =   840
   ...
   End
End
Attribute VB_Name = "frmWhatUseObject"
...
Private Function BuildTreeView(ByVal strName As String, ByVal strType As String, ByVal strParentKey As String, ByVal TV As TreeView) As Boolean
    ...
    strText = GetObjectText(objCatLocal, strName, strType)
    For Each v In SQLObjects
        If strName <> v(0) Then
            If WordInsideText(v(0), strText, 1) Then
